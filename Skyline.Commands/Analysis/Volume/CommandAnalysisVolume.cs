...
{
    public class CommandAnalysisVolume:Skyline.Define.SkylineBaseCommand
    {
        ...
        {            
            FrmTerrainModifier fmTerrModifier = new FrmTerrainModifier(base.m_Hook.UIHook.MainForm);
            ...
            try
            {
                ...
                {
                    this.m_Hook.UIHook.MainForm.AddOwnedForm(fmTerrModifier);
                    fmTerrModifier.Show();
                }
            }
            catch 
