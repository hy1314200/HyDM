...
namespace Utility
{
    ...
    public class StringWriter
    {
        ...
        public StringWriter(string strFile, bool autoFlush)
        {
        ...
        public StringWriter(string strFile, bool autoFlush, string strInitContents)
        {
            this.m_FileName = strFile;
            this.AutoFlush = autoFlush;
        ...
        private void OpenStream()
        {
            ...
            this.AutoFlush = this.m_AutoFlush;
        }
