...
应用程序向导已为您创建了此 Test 项目，作为编写动态链接库 (DLL) 
的起点。
...
Testps.vcxproj
    ...
    文件。此进程生成 dlldata.c、Test_i.c 和 
    Test_p.c，这些文件是生成代理/存根 (stub) DLL 所必需的。

Testps.vcxproj.filters
