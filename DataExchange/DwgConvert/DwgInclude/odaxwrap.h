...
IAcadBaseObject : public IUnknown
{
  ...
  virtual HRESULT STDMETHODCALLTYPE SetObjectId(OdDbObjectId& objId, 
    OdDbObjectId ownerId = OdDbObjectId::kNull, TCHAR* keyName = NULL) = 0;
...
// Utility functions
//
IUnknownPtr TOOLKIT_EXPORT OdOxGetIUnknownOfObject(OdDbObjectId objId, LPDISPATCH pApp);
IUnknownPtr TOOLKIT_EXPORT OdOxGetIUnknownOfObject(OdDbObject* pObj, LPDISPATCH pApp);
IUnknownPtr TOOLKIT_EXPORT OdOxGetIUnknownOfDatabase(OdDbDatabase* pDb, LPDISPATCH pApp);
