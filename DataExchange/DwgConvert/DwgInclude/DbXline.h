...
/** Description:
    This class represents Xline entities in an OdDbDatabase instance.

    Library:
    Db

    Remarks:
    An Xline is an infinite line.
...
/** Description:
    This template class is a specialization of the OdSmartPtr class for OdDbXline object pointers.
*/
