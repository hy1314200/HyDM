...
public:                                                                                              \
                                                                                                     \
  /* Casts the passed in pointer to a ClassName SmartPointer.                   */                   \
  ...
  virtual OdRxClass* isA() const;                                                                    \
                                                                                                     \
  /* Returns a pointer to the protocol extension object for this object.        */                   \
  /* Return null if no protocol extension object is is found.                   */                   \
  virtual OdRxObject* queryX(const OdRxClass* protocolClass) const;                                  \
                                                                                                     \
  /* Creates a new instance of this object type, and returns a SmartPointer     */                   \
  /* to this instance.                                                          */                   \
...
#define ODRX_NO_CONS_DEFINE_MEMBERS_ALTNAME(ClassName,ParentClass,szClassName)                       \
                                                                                                     \
ODRX_DEFINE_MEMBERS2(ClassName,ParentClass,0,0,0,0,szClassName,0,0)                                  \
                                                                                                     \
...
#define ODRX_NO_CONS_DEFINE_MEMBERS(ClassName,ParentClass)                                           \
                                                                                                     \
ODRX_NO_CONS_DEFINE_MEMBERS_ALTNAME(ClassName,ParentClass,#ClassName)



#define ODRX_CONS_DEFINE_MEMBERS_ALTNAME(ClassName,ParentClass,szClassName,DOCREATE)                 \
                                                                                                     \
ODRX_DEFINE_MEMBERS2(ClassName,ParentClass,ClassName::pseudoConstructor,0,0,0,szClassName,0,0)       \
                                                                                                     \
ODRX_DEFINE_PSEUDOCONSTRUCTOR(ClassName,DOCREATE)
...
#define ODRX_CONS_DEFINE_MEMBERS(ClassName,ParentClass,DOCREATE)                                     \
                                                                                                     \
ODRX_CONS_DEFINE_MEMBERS_ALTNAME(ClassName,ParentClass,#ClassName,DOCREATE)
...
ODRX_DEFINE_MEMBERS(ClassName,ParentClass,DOCREATE,                                                             \
    DwgVer,MaintVer,nProxyFlags,#ClassName,#DxfName,#AppName)
...
public:
  ...
  */
  ...
  /** Description:
    Returns the a pointer to the OdRxClass object that contains a description
    of this object type, objects of unknown class type.
...
public:
  ...
  /** Description:
    Creates a Protocol Extension for the specified OdRxClass.
  ...
  */
  ...
  /** Description:
    Returns a SmartPointer to the Protocol Extension for the specified
  ...
  */
  ...
  /** Description:
    ...
    Remarks:
    Returns a SmartPointer to the Protocol Extension Object.
  ...
  */
  ...
  /** Description:
    ...
    Arguments:
    pMaintVer (O) Returns the maintenance version.
  */
  virtual OdDb::DwgVersion getClassVersion(
    OdDb::MaintReleaseVer* pMaintVer = NULL) const = 0;
  ...
  */
  ...
  /** Description:
    Returns a pointer to the parent of this OdRxClass.
  */
  virtual OdRxClass* myParent() const = 0;

  /** Description:
    Returns a pointer to the OdRxModule in which the class is resides.
...
/** Description:
    This template class is a specialization of the OdSmartPtr class template for OdRx classes.
*/
