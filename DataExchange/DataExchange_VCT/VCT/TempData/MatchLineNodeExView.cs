...
{
    class MatchLineNodeExView:BaseTable
    {
        public MatchLineNodeExView(OleDbConnection pOleDbConnection)
        ...
        public virtual void GetLineByDataRow(DataRow dataRow, ref MatchLineNodeEx matchLineNode)
        {
            if (dataRow != null)
            {
