...
namespace DIST.DGP.DataExchange.VCT
{
    ...
    public class Logger
    {
        ...
        public static void WriteErrorLog(Exception ep)
        {
            try
            {
                ...
                if (Logger.LogWriter != null)
                {
                    ...
                    Logger.LogWriter.WriteLine("错误发生时间 ：" + DateTime.Now);
                    Logger.LogWriter.WriteLine("Message :" + ep.Message);
                    Logger.LogWriter.WriteLine("Source :" + ep.Source);
                    Logger.LogWriter.WriteLine("StackTrace :" + ep.StackTrace);
                    Logger.LogWriter.WriteLine("TargetSite :" + ep.TargetSite);
        ...
        public static bool SetLogFilePath(string strFilePath)
        {
            ...
            if (pFileStream != null)
                pStreamWrite = new StreamWriter(Logger.FileLog);
            return true;
        }
        /// <summary>
        /// 记录日志信息
        ...
        public static void WriteLog(string sMessage)
        {
            ...
            {
                Logger.LogWriter.WriteLine();
                Logger.LogWriter.WriteLine("Log :" + sMessage);
                Logger.LogWriter.Flush();
            }
        }
    }
