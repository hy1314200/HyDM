...
MIDL_DEFINE_GUID(IID, IID_IXData,0xA6F0CAA6,0xB84E,0x4E72,0xB1,0xE4,0x27,0x63,0x24,0x2C,0xCC,0xDE);
...
MIDL_DEFINE_GUID(CLSID, CLSID_XData,0x028DDEA1,0xD1D9,0x4350,0x80,0x2D,0xDD,0xDE,0xCF,0xBF,0x7D,0x22);
