...
#Region "内部变量"
    ...
    Private p_MapServerType As MapServerType = MapServerType.Sde
...
#Region "属性"
    ...
    Public Property MapServerType() As MapServerType
        Get
            Return Me.p_MapServerType
        End Get
        Set(ByVal value As MapServerType)
    ...
    Property SdeType() As SdeType
        Get
            Return Me.p_SdeType
        End Get
        Set(ByVal value As SdeType)
            Me.p_SdeType = value
        End Set
    End Property
