...
namespace Hy.Oracle
{
    public class HyOracleCommand:DbCommand
    {
        ...
        internal HyOracleCommand(DDTek.Oracle.OracleCommand cmd)
        {
            this.m_Command = cmd;
            this.m_Connection = new HyOracleConnection(cmd.Connection);
        }

        public HyOracleCommand():this(new DDTek.Oracle.OracleCommand())
        {
        ...
        protected override DbTransaction DbTransaction
        {
            get
            {
                if (this.m_Transaction == null)
                    this.m_Transaction = new HyOracleTransaction(this.m_Command.Transaction);
