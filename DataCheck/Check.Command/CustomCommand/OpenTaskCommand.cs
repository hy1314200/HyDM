...
namespace Check.Command.CustomCommand
{
    ...
    public sealed class OpenTaskCommand : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            Check.UI.Forms.FrmOPenTask frmTaskOpen = new Check.UI.Forms.FrmOPenTask();
            ...
            if (frmTaskOpen.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                // Ð´ÈëÊý¾Ý¿â
                if (!Check.Task.TaskHelper.TaskExistsInDB(CheckApplication.CurrentTask.Name, CheckApplication.CurrentTask.Path))
                {
                    Check.Task.TaskHelper.AddTask(CheckApplication.CurrentTask);
                }
            }
        }
