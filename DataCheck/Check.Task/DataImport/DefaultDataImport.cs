...
namespace Check.Task.DataImport
{
    ...
    public abstract class DefaultDataImport:IDataImport 
    {
        ...
        private void RenameClassObject(IDataset dsCurrent,int standardID)
        {
            ...
            Check.Define.StandardLayer standardLayer = LayerReader.GetLayerByName(dsCurrent.Name, standardID);
            //string strAliasName = Check.Rule.Helper.LayerReader.GetAliasName(dsCurrent.Name, standardID);
            if (standardLayer!=null)// dsCurrent.Name != strAliasName)
            {
                ...
                if (classSchemaEdit != null)
                {
                    ...
                    if (tCurrent != null)
                    {
                        List<Check.Define.StandardField> fields = FieldReader.GetFieldsByLayer(standardLayer.ID);
