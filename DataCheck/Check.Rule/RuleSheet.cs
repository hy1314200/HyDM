...
namespace Rule
{
    public class RuleSheet : BaseRule
    {
        ...
        public override Check.Define.IParameterSetter GetParameterSetter()
        {
            return null;
        }
        ...
        public override bool Check(ref List<Check.Define.Error> checkResult)
        {
        ...
        private bool CheckbyAdo(ref List<Check.Define.Error> checkResult)
        {
            ...
            try
            {
                ...
                checkResult = new List<Check.Define.Error>();

                foreach (DataRow dr in ipRecordset.Rows) //遍历结果集
                {
                    if (dr != null)
                    {
                        Check.Define.Error res = new Check.Define.Error();
